  ...
  return (
    <div className="auth-page">
      <div className="auth-wrapper">
        <Card className="auth-card-main">
          <Card.Body className="d-flex flex-column align-items-center text-center">
            <div className="auth-header-logo w-100">
              <img src={iconImg} alt="Logo" className="main-logo-top" />
            ...
            <Form onSubmit={handleSubmit} className="w-100">
              <Form.Group className="mb-4">
                <Form.Control
                  ...
                  placeholder="admin@furiosos.com"
              ...
              <Button variant="primary" type="submit" className="w-100 btn-auth mb-3" disabled={isLoading}>
                {isLoading ? <Spinner animation="border" size="sm" /> : "ENTRAR"}
              </Button>
            </Form>

            <div className="auth-divider w-100"><span>ou</span></div>

            <div className="auth-footer-phrase w-100">
              <p>Aqui, mais que um esporte, formamos <span className="highlight-orange">campeões</span> para a vida!</p>
