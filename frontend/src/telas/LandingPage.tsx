    ...
    <div className="admin-landing-page">
      ...
      <Container>
        <header className="text-center mb-5">
          ...
          >
            FORMANDO PEQUENOS ATLETAS, CONSTRUINDO GRANDES FUTUROS
          </p>
        </header>
        ...
        <section className="white-section-card">
            ...
            <Col md={4}>
              <div className="skill-item">
                ...
                <div className="skill-text">
                  <h6>Acrobacias</h6>
                  <p>
                    Movimentos que exigem força, equilíbrio e muita técnica.
                  </p>
                </div>
              </div>
            </Col>
            ...
            <Col md={4}>
              <div className="skill-item">
                ...
                <div className="skill-text">
                  ...
                  <p>
                    Desenvolvimento físico e mental dentro e fora do esporte.
                  </p>
                </div>
              </div>
            </Col>
          ...
          <div className="dark-project-banner">
            <Row className="align-items-center">
              <Col lg={6} className="project-info-text pe-lg-4">
                ...
                <p>
                  Fundado em <strong>2018</strong>, o Furiosos Kids é o projeto
                  social da faculdade UTFPR em Cornélio Procópio. Atendemos
                  crianças da comunidade, ensinando os valores do esporte.
                </p>
                <p>
                  Atualmente, o time é <strong>Campeão do Cheerfest</strong>, um
                  dos campeonatos mais prestigiados da modalidade!
                </p>
              </Col>
              <Col lg={6}>
          ...
          <div className="video-banner-section">
            ...
            <div
              ...
              onClick={() =>
                window.open(
                  "https://www.youtube.com/watch?v=WN2uZYWOCxs",
                  "_blank",
                )
              }
            >
